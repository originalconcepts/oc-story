	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n' => array(
					'title'        => __( 'Where the videos show', 'oc-story' ),
					'add'          => __( 'Add a place', 'oc-story' ),
					'empty'        => __( 'The videos are not showing anywhere yet', 'oc-story' ),
					'emptyHint'    => __( 'Add a place and choose which pages it appears on.', 'oc-story' ),
					'name'         => __( 'Name this, for yourself', 'oc-story' ),
					'namePlaceholder' => __( 'Home page circles', 'oc-story' ),
