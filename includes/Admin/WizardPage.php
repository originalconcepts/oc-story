...
class WizardPage {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'days'      => \OCS\Model\ShareLink::SPANS,
				'types'     => $this->types(),
	...
	protected function strings() {
		return array(
			...
			'linkTitle'        => __( 'Upload from your phone', 'oc-story' ),
			'linkMake'         => __( 'Make a link', 'oc-story' ),
			'linkRemake'       => __( 'Make a new link', 'oc-story' ),
			'linkOpen'         => __( 'Phone link', 'oc-story' ),
			'linkWhat'         => __( 'A link you send to yourself. Open it on your phone and you can add videos to this gallery without signing in to the admin.', 'oc-story' ),
			'linkOnce'         => __( 'Here it is. Send it to yourself now — it is shown this once and never again.', 'oc-story' ),
			'linkCopy'         => __( 'Copy', 'oc-story' ),
			'linkCopied'       => __( 'Copied.', 'oc-story' ),
			'linkSend'         => __( 'Send', 'oc-story' ),
			'linkClaimWindow'  => __( 'Open it on your phone within 30 minutes. The first phone to open it is the only one it will ever work on.', 'oc-story' ),
			'linkState'        => __( 'This link', 'oc-story' ),
			'linkClaimed'      => __( 'In use on one phone', 'oc-story' ),
			'linkWaiting'      => __( 'Waiting to be opened', 'oc-story' ),
			'linkStale'        => __( 'Never opened — make a new one', 'oc-story' ),
			'linkLastUsed'     => __( 'Last used', 'oc-story' ),
			'linkDies'         => __( 'Stops working', 'oc-story' ),
			'linkAdded'        => __( 'Videos added through it', 'oc-story' ),
			'linkGone'         => __( 'The address itself is not kept — it is stored the way a password is. Make a new one if you have lost it; the old one dies the moment you do.', 'oc-story' ),
			'linkIdle'         => __( 'Stops working after this long unused', 'oc-story' ),
			/* translators: %d: number of days. */
			'linkDays'         => __( '%d days', 'oc-story' ),
			'linkHold'         => __( 'Uploads wait for me to approve them', 'oc-story' ),
			'linkHoldNote'     => __( 'Off for your own phone. Turn it on if you ever send this link to somebody else.', 'oc-story' ),
			'linkKill'         => __( 'Stop this link', 'oc-story' ),
