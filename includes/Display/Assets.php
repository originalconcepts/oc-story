		...
		wp_add_inline_script(
			...
			'window.ocsCfg=' . wp_json_encode(
				array(
					...
					'panel'  => (string) Settings::get( 'cart_panel', 'compact' ),
					...
					'i18n'   => array(
						...
						'soldOut'     => __( 'Out of stock', 'oc-story' ),
						'quantity'    => __( 'Quantity', 'oc-story' ),
						'readMore'    => __( 'read more', 'oc-story' ),
						'reviews'     => __( '(%d)', 'oc-story' ),
						'openProduct' => __( 'Open the product page', 'oc-story' ),
